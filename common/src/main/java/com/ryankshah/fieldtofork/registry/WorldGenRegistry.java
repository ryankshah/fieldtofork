...
public class WorldGenRegistry
{
    ...
    public static final ResourceKey<PlacedFeature> FLOWERS_RK = ResourceKey.create(Registries.PLACED_FEATURE, ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "flowers_pf"));
    public static final ResourceKey<ConfiguredFeature<?,?>> FLOWERS_CF_RK = ResourceKey.create(Registries.CONFIGURED_FEATURE, ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "flowers_cf"));


//    public static final ResourceKey<PlacedFeature> IRIS_FLOWER_RK = ResourceKey.create(Registries.PLACED_FEATURE, ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "iris_flower_pf"));
//    public static final ResourceKey<ConfiguredFeature<?,?>> IRIS_FLOWER_CF_RK = ResourceKey.create(Registries.CONFIGURED_FEATURE, ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "iris_flower_cf"));
//
//    public static final ResourceKey<PlacedFeature> CROCUS_VERNUS_RK = ResourceKey.create(Registries.PLACED_FEATURE, ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "crocus_vernus_pf"));
//    public static final ResourceKey<ConfiguredFeature<?,?>> CROCUS_VERNUS_CF_RK = ResourceKey.create(Registries.CONFIGURED_FEATURE, ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "crocus_vernus_cf"));
//
//    public static final ResourceKey<PlacedFeature> CROCUS_FLAVUS_RK = ResourceKey.create(Registries.PLACED_FEATURE, ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "crocus_flavus_pf"));
//    public static final ResourceKey<ConfiguredFeature<?,?>> CROCUS_FLAVUS_CF_RK = ResourceKey.create(Registries.CONFIGURED_FEATURE, ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "crocus_flavus_cf"));
//
//    public static final ResourceKey<PlacedFeature> DAFFODIL_RK = ResourceKey.create(Registries.PLACED_FEATURE, ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "daffodil_pf"));
//    public static final ResourceKey<ConfiguredFeature<?,?>> DAFFODIL_CF_RK = ResourceKey.create(Registries.CONFIGURED_FEATURE, ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "daffodil_cf"));
    ...
    //Flowers
    public static final Supplier<Feature<RandomPatchConfiguration>> FLOWERS_F = FEATURES.register("flowers", () -> new RandomPatchFeature(RandomPatchConfiguration.CODEC));
//    public static final Supplier<Feature<RandomPatchConfiguration>> IRIS_FLOWER_F = FEATURES.register("iris_flower", () -> new RandomPatchFeature(RandomPatchConfiguration.CODEC));
//    public static final Supplier<Feature<RandomPatchConfiguration>> CROCUS_VERNUS_F = FEATURES.register("crocus_vernus", () -> new RandomPatchFeature(RandomPatchConfiguration.CODEC));
//    public static final Supplier<Feature<RandomPatchConfiguration>> CROCUS_FLAVUS_F = FEATURES.register("crocus_flavus", () -> new RandomPatchFeature(RandomPatchConfiguration.CODEC));
//    public static final Supplier<Feature<RandomPatchConfiguration>> DAFFODIL_F = FEATURES.register("daffodil", () -> new RandomPatchFeature(RandomPatchConfiguration.CODEC));
}