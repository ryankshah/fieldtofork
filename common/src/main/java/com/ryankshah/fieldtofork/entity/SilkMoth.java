package com.ryankshah.fieldtofork.entity;
...
public class SilkMoth extends PathfinderMob implements GeoEntity
{
    ...
    class WanderGoal extends Goal {
        ...
        public void start() {
            ...
            if (vector3d != null) {
                SilkMoth.this.navigation.moveTo(SilkMoth.this.navigation.createPath(new BlockPos((int)vector3d.x(), (int)vector3d.y(), (int)vector3d.z()), 1), 1.0D);
            }
        ...
        private Vec3 findPos() {
            Vec3 vector3d = SilkMoth.this.getViewVector(0.0F);
            int i = 4;
            Vec3 vec32 = HoverRandomPos.getPos(SilkMoth.this, 8, 7, vector3d.x, vector3d.z, ((float)Math.PI / 2F), 3, 1);
            return vec32 != null ? vec32 : AirAndWaterRandomPos.getPos(SilkMoth.this, 8, 4, -2, vector3d.x, vector3d.z, (double)((float)Math.PI / 2F));
        }
    }
