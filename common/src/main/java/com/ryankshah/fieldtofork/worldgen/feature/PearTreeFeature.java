...
public class PearTreeFeature extends Feature<TreeConfiguration>
{
    private static final ResourceLocation[] TREES = {
            ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "trees/pear_tree_1"),
            ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "trees/pear_tree_2")
    };

    public PearTreeFeature(final Codec<TreeConfiguration> codec) {
        super(codec);
    }
