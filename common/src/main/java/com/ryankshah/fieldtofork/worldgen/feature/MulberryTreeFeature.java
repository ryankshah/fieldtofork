...
public class MulberryTreeFeature extends Feature<TreeConfiguration>
{
    private static final ResourceLocation[] TREES = {
            ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "trees/mulberry_tree_1"),
            ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "trees/mulberry_tree_2")
    };

    public MulberryTreeFeature(final Codec<TreeConfiguration> codec) {
        super(codec);
    }
