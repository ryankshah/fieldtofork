...
public class MangoTreeFeature extends Feature<TreeConfiguration>
{
    private static final ResourceLocation[] TREES = {
            ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "trees/mango_tree_1"),
            ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "trees/mango_tree_2")
    };

    public MangoTreeFeature(final Codec<TreeConfiguration> codec) {
        super(codec);
    }
