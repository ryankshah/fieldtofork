...
public class DragonfruitTreeFeature extends Feature<TreeConfiguration>
{
    private static final ResourceLocation[] TREES = {
            ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "trees/dragonfruit_tree_1"),
            ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "trees/dragonfruit_tree_2")
    };

    public DragonfruitTreeFeature(final Codec<TreeConfiguration> codec) {
        super(codec);
    }
