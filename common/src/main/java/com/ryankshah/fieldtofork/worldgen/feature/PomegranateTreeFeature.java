...
public class PomegranateTreeFeature extends Feature<TreeConfiguration>
{
    private static final ResourceLocation[] TREES = {
            ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "trees/pomegranate_tree_1"),
            ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "trees/pomegranate_tree_2"),
            ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "trees/pomegranate_tree_3")
    };

    public PomegranateTreeFeature(final Codec<TreeConfiguration> codec) {
        super(codec);
    }
