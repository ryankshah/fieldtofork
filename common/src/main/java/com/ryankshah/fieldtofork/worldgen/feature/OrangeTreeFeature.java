...
public class OrangeTreeFeature extends Feature<TreeConfiguration>
{
    private static final ResourceLocation[] TREES = {
            ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "trees/orange_tree_1"),
            ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "trees/orange_tree_2")
    };

    public OrangeTreeFeature(final Codec<TreeConfiguration> codec) {
        super(codec);
    }
