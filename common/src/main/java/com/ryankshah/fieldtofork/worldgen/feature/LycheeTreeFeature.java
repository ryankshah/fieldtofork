...
public class LycheeTreeFeature extends Feature<TreeConfiguration>
{
    private static final ResourceLocation[] TREES = {
            ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "trees/lychee_tree_1"),
            ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "trees/lychee_tree_2")
    };

    public LycheeTreeFeature(final Codec<TreeConfiguration> codec) {
        super(codec);
    }
